...
Test1_hr(double l,double b,double h)
{
  super(l,b);
  this.length=l;
  this.breadth=b;
...
public static void main(String args[]){
    ...
    Test1_hr myshape1 = new Test1_hr(l,h);
    Test1_hr myshape2 = new Test1_hr(l,b,h);
    double volume1;
    double volume2;
